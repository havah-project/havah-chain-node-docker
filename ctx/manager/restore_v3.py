...
class Restore:
    def __init__(self,
        ...
        self.cfg.logger.info(f"download_url={self.download_url}")
        # Send url check
    ...
    def _prepare(self):
        ...
        if download_info_res.status_code == 200:
            ...
            self.cfg.logger.error(f'[RESTORE] [ERROR] Invalid url or service name, url={download_info_url}, '
    ...
    def file_download(self, download_url, download_path, hash_value=None):
        ...
        try:
            ...
            if self.download_force or hash_value == "skip":
